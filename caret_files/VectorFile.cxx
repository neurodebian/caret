 ...
 * Constructor.
 */
VectorFile::VectorFile(const int xdim, const int ydim, const int zdim)
 : AbstractFile("Vector File", 
                SpecFile::getVectorFileExtension(),
                true,
 ...
 */
void
VectorFile::initialize(const int xdim, const int ydim, const int zdim)
{
   dimensions[0] = xdim;
   dimensions[1] = ydim;
   dimensions[2] = zdim;
 ...
 */
void 
VectorFile::getDimensions(int dim[3]) const
{
   dim[0] = dimensions[0];
   dim[1] = dimensions[1];
   dim[2] = dimensions[2];
 ...
 */
void 
VectorFile::getDimensions(int& dimX, int& dimY, int& dimZ) const
{
   dimX = dimensions[0];
   dimY = dimensions[1];
   dimZ = dimensions[2];
 ...
 */
void 
VectorFile::getVectorWithFlatIndex(const int indx, float& xOut, float& yOut, float& zOut) const
{
   xOut = x[indx];
   yOut = y[indx];
   zOut = z[indx];
 ...
 */
void 
VectorFile::getVectorWithFlatIndex(const int indx, float xyzOut[3]) const
{
   xyzOut[0] = x[indx];
   xyzOut[1] = y[indx];
   xyzOut[2] = z[indx];
 ...
 */
void 
VectorFile::setVectorWithFlatIndex(const int indx, const float xIn, 
 ...
 */
void 
VectorFile::setVectorWithFlatIndex(const int indx, float xyzIn[3])
{
   x[indx] = xyzIn[0];
   y[indx] = xyzIn[1];
   z[indx] = xyzIn[2];
 ...
 */
void 
VectorFile::combineWithVolumeOperation(const COMBINE_VOLUME_OPERATION operation,
 ...
 */
void 
VectorFile::copyMagnitudeToVolume(VolumeFile* vf) const throw (FileException)
{
   int volDim[3];
   vf->getDimensions(volDim);
   for (int i = 0; i < 3; i++) {
 ...
 */
void 
VectorFile::combineVectorFiles (const bool maskingFlag, 
 ...
 */
void 
VectorFile::multiplyXYZByMagnitude()
{
   const int num = dimensions[0] * dimensions[1] * dimensions[2];
   for (int i = 0; i < num; i++) {
      x[i] *= magnitude[i];
 ...
 */
float* 
VectorFile::getWithFlatIndexValueX(const int indx)
{
   return &x[indx];
}
 ...
 */
float* 
VectorFile::getWithFlatIndexValueY(const int indx)
{
   return &y[indx];
}
 ...
 */
float* 
VectorFile::getWithFlatIndexValueZ(const int indx)
{
   return &z[indx];
}
 ...
 */
void 
VectorFile::getVector(const int i, const int j, const int k, float vector[3]) const
{
 ...
 */
float 
VectorFile::getMagnitude(const int i, const int j, const int k) const
{
   const int indx = getDataIndex(i, j, k);
 ...
 */
int 
VectorFile::getDataIndex(const int ijk[3]) const
{
 ...
 */
int 
VectorFile::getDataIndex(const int i, const int j, const int k) const
{      
 ...
 */
void 
VectorFile::writeFileData(QTextStream& stream,
                          QDataStream& binStream,
                                 QDomDocument& /* xmlDoc */,
                                  QDomElement& /* rootElement */) throw (FileException)
{
