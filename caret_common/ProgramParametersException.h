...
/// class for an exception for program parameters
class ProgramParametersException :public std::exception {
   public:
      /// Constructor
      ProgramParametersException(const QString& msg);
...
#endif // __PROGRAM_ARGUMENTS_EXCEPTION_H__
