 ...
 * Constructor.
 */
QtSaveWidgetAsImagePushButton::QtSaveWidgetAsImagePushButton(const QString& text,
                              QWidget* parent,
                              QWidget* widgetToSaveIn)
   : QPushButton(text, parent)
{
   setAutoDefault(false);
   widgetToSave = widgetToSaveIn;
 ...
 * Destructor.
 */
QtSaveWidgetAsImagePushButton::~QtSaveWidgetAsImagePushButton()
{
}
 ...
 */
void 
QtSaveWidgetAsImagePushButton::slotClicked()
{
   ...
   if (saveImageDialog.exec() == WuQFileDialog::Accepted) {
      ...
      QImage image = QPixmap::grabWidget(widgetToSave).toImage();
