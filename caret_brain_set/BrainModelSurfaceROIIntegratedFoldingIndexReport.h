...
#ifndef __BRAIN_MODEL_SURFACE_ROI_INTEGRATED_FOLDING_INDEX_REPORT_H__
#define __BRAIN_MODEL_SURFACE_ROI_INTEGRATED_FOLDING_INDEX_REPORT_H__
...
class BrainModelSurfaceROIIntegratedFoldingIndexReport : public BrainModelSurfaceROIOperation {
   public:
      // constructor
      BrainModelSurfaceROIIntegratedFoldingIndexReport(BrainSet* bs,
...
#endif // __BRAIN_MODEL_SURFACE_ROI_INTEGRATED_FOLDING_INDEX_REPORT_H__
