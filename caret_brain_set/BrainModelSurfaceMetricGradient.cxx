...
void 
BrainModelSurfaceMetricGradient::initialize()
{
 ...
 */
void 
BrainModelSurfaceMetricGradient::executeSingleColumn() throw (BrainModelAlgorithmException)
{
   //
...
/**
 * execute the all metric columns.
 */
void 
BrainModelSurfaceMetricGradient::executeAllColumns() throw (BrainModelAlgorithmException)
{
   //
   // Verify files exist, are valid, etc.
   //
 ...
 */
void 
BrainModelSurfaceMetricGradient::processSingleColumn(const TopologyHelper* myhelper,
