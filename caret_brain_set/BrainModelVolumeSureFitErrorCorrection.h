...
class BrainModelVolumeSureFitErrorCorrection : public BrainModelAlgorithm {
   ...
   protected:
      ...
      std::vector<QString> intermediateFileNames;
      
      // intermediate volume files in memory
      std::map<QString,VolumeFile*> intermediateVolumeFilesInMemory;
      
      // keep intermediate files in memory flag
      bool keepIntermediateFilesInMemoryFlag;
