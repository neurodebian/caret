...
#ifndef __BRAIN_MODEL_SURFACE_ROI_PAINT_REPORT_H__
#define __BRAIN_MODEL_SURFACE_ROI_PAINT_REPORT_H__
...
/// class for performing paint region of interest operations on a surface
class BrainModelSurfaceROIPaintReport : public BrainModelSurfaceROIOperation {
   public:      
      // constructor
      BrainModelSurfaceROIPaintReport(BrainSet* bs,
   ...
   protected:
      ...
      /// paint column for paint region report
      int paintRegionColumnNumber;
...
#endif // __BRAIN_MODEL_SURFACE_ROI_PAINT_REPORT_H__
