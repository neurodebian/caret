...
#ifndef __COMMAND_SHOW_SURFACE_H__
#define __COMMAND_SHOW_SURFACE_H__
...
/// class for showing a surface
class CommandShowSurface : public CommandBase {
   public:
      // constructor 
      CommandShowSurface();
...
#endif // __COMMAND_SHOW_SURFACE_H__
