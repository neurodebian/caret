...
#ifndef __COMMAND_SURFACE_TO_C_ARRAYS_H__
#define __COMMAND_SURFACE_TO_C_ARRAYS_H__
...
/// class for
class CommandSurfaceToCArrays : public CommandBase {
   public:
      // constructor 
...
#endif // __COMMAND_SURFACE_TO_C_ARRAYS_H__
