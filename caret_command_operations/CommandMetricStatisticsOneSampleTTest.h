...
#ifndef __COMMAND_METRIC_STATISTICS_ONE_SAMPLE_T_TEST_H__
...
/// class for
class CommandMetricStatisticsOneSampleTTest : public CommandBase {
   public:
      // constructor 
      CommandMetricStatisticsOneSampleTTest();
...
#endif // __COMMAND_METRIC_STATISTICS_ONE_SAMPLE_T_TEST_H__
