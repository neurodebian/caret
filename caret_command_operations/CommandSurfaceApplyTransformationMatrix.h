...
#ifndef __COMMAND_SURFACE_APPLY_TRANSFORMATION_MATRIX_H__
...
/// class for applying a transformation matrix to a surface
class CommandSurfaceApplyTransformationMatrix : public CommandBase {
   public:
      // constructor 
...
#endif // __COMMAND_SURFACE_APPLY_TRANSFORMATION_MATRIX_H__
