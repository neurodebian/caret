 ...
 * constructor.
 */
CommandVolumeMakeShell::CommandVolumeMakeShell()
   : CommandBase("-volume-make-shell",
                 "VOLUME MAKE SHELL")
{
}
 ...
 */
void 
CommandVolumeMakeShell::getScriptBuilderParameters(ScriptBuilderParameters& paramsOut) const
{
   paramsOut.clear();
   ...
   paramsOut.addInt("Erosion Iterations");
}
 ...
 */
QString 
CommandVolumeMakeShell::getHelpInformation() const
{
   QString helpInfo =
 ...
 */
void 
CommandVolumeMakeShell::executeCommand() throw (BrainModelAlgorithmException,
                                     CommandException,
                                     FileException,
