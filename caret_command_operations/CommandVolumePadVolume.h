...
#ifndef __COMMAND_VOLUME_PAD_VOLUME_H__
#define __COMMAND_VOLUME_PAD_VOLUME_H__
...
/// class for padding a volume
class CommandVolumePadVolume : public CommandBase {
   public:
      // constructor 
...
#endif // __COMMAND_VOLUME_PAD_VOLUME_H__
