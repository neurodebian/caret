 ...
 * constructor.
 */
CommandSurfaceSulcalNamedAllIdentification::CommandSurfaceSulcalNamedAllIdentification()
   : CommandBase("-surface-sulcal-named-all-identification",
 ...
 */
void
CommandSurfaceSulcalNamedAllIdentification::getScriptBuilderParameters(ScriptBuilderParameters& paramsOut) const
{
   paramsOut.clear();
 ...
 */
QString 
CommandSurfaceSulcalNamedAllIdentification::getHelpInformation() const
{
   QString helpInfo =
      (indent3 + getShortDescription() + "\n"
       ...
       + indent9 + "\n" 
       + indent9 + "Identify sulci on a surface. \n" 
       + indent9 + "\n"
 ...
 */
void 
CommandSurfaceSulcalNamedAllIdentification::executeCommand() throw (BrainModelAlgorithmException,
                                     CommandException,
                                     FileException,
                                     ...
                                     StatisticException)
{
   ...
   // Identify the sulci
   //
   BrainModelSurfaceSulcalIdentificationAll bmssi(&brainSet,
                                                  fiducialSurface,
                                                  veryInflatedSurface,
