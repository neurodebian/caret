...
#ifndef __COMMAND_SPEC_FILE_CLEAN_H__
#define __COMMAND_SPEC_FILE_CLEAN_H__
...
/// class for
class CommandSpecFileClean : public CommandBase {
   public:
      // constructor 
...
#endif // __COMMAND_SPEC_FILE_CLEAN_H__
