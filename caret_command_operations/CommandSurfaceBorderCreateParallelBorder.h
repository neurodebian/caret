...
#ifndef __COMMAND_SURFACE_BORDER_CREATE_PARALLEL_BORDER_H__
...
/// class for creating a new border parallel to an existing border
class CommandSurfaceBorderCreateParallelBorder : public CommandBase {
   public:
      // constructor 
...
#endif // __COMMAND_SURFACE_BORDER_CREATE_PARALLEL_BORDER_H__
