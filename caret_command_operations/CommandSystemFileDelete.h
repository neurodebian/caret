...
#ifndef __COMMAND_SYSTEM_FILE_DELETE_H__
#define __COMMAND_SYSTEM_FILE_DELETE_H__
...
class CommandSystemFileDelete : public CommandBase {
   public:
      // constructor 
...
#endif // __COMMAND_SYSTEM_FILE_DELETE_H__
