 ...
 * constructor.
 */
CommandMetricStatisticsOneSampleTTest::CommandMetricStatisticsOneSampleTTest()
   : CommandBase("-metric-statistics-one-sample-t-test",
                 "METRIC STATISTICS ONE SAMPLE T-TEST")
{
}
 ...
 */
void 
CommandMetricStatisticsOneSampleTTest::getScriptBuilderParameters(ScriptBuilderParameters& paramsOut) const
{
   paramsOut.clear();
   paramsOut.addFile("Metric or Shape File Name", FileFilters::getMetricShapeFileFilter());
   ...
   paramsOut.addFile("Distoration Metric or ShapeFile Name", FileFilters::getMetricShapeFileFilter());
   ...
   paramsOut.addFloat("T-Test Constant");
 ...
 */
QString 
CommandMetricStatisticsOneSampleTTest::getHelpInformation() const
{
   QString helpInfo =
 ...
 */
void 
CommandMetricStatisticsOneSampleTTest::executeCommand() throw (BrainModelAlgorithmException,
                                     CommandException,
                                     FileException,
                                     ProgramParametersException,
                                     StatisticException)
{
   const QString metricShapeFile = 
   ...
   const float tTestConstant = 
      parameters->getNextParameterAsFloat("T-Test Constant");
   ...
   const QString ext = metricShapeFile.endsWith(SpecFile::getMetricFileExtension())
