...
#ifndef __COMMAND_CARET_FILE_COPY_H__
#define __COMMAND_CARET_FILE_COPY_H__
...
/// class for
class CommandCaretFileCopy : public CommandBase {
   public:
      // constructor
...
#endif // __COMMAND_CARET_FILE_COPY_H__
