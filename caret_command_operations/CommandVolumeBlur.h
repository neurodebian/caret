...
#ifndef __COMMAND_VOLUME_BLUR_H__
#define __COMMAND_VOLUME_BLUR_H__
...
/// class for volume blurring
class CommandVolumeBlur : public CommandBase {
   public:
      // constructor 
      CommandVolumeBlur();
...
#endif // __COMMAND_VOLUME_BLUR_H__
