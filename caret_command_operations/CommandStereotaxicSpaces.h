...
#ifndef __COMMAND_STEREOTAXIC_SPACES_H__
#define __COMMAND_STEREOTAXIC_SPACES_H__
...
/// class for
class CommandStereotaxicSpaces : public CommandBase {
   public:
      // constructor 
      CommandStereotaxicSpaces();
...
#endif // __COMMAND_STEREOTAXIC_SPACES_H__
