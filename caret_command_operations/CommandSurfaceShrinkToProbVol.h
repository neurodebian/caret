...
#ifndef __COMMAND_SURFACE_SHRINK_TO_PROB_VOL_H__
#define __COMMAND_SURFACE_SHRINK_TO_PROB_VOL_H__
...
/// class for
class CommandSurfaceShrinkToProbVol : public CommandBase {
   public:
      // constructor 
      CommandSurfaceShrinkToProbVol();
