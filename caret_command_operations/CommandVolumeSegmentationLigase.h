...
#ifndef __COMMAND_VOLUME_SEGMENTATION_LIGASE_H__
#define __COMMAND_VOLUME_SEGMENTATION_LIGASE_H__
...
/// class for
class CommandVolumeSegmentationLigase : public CommandBase {
   public:
      // constructor 
      CommandVolumeSegmentationLigase();
