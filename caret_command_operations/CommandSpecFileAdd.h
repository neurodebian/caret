...
#ifndef __COMMAND_SPEC_FILE_ADD_H__
#define __COMMAND_SPEC_FILE_ADD_H__
...
/// class for adding items to a spec file
class CommandSpecFileAdd : public CommandBase {
   public:
      // constructor 
      CommandSpecFileAdd();
      ...
      static void addTagAndFileToSpecFile(const QString& specFileName,
...
#endif // __COMMAND_SPEC_FILE_ADD_H__
