...
#ifndef __COMMAND_IMAGE_INSERT_TEXT_H__
#define __COMMAND_IMAGE_INSERT_TEXT_H__
...
/// class for
class CommandImageInsertText : public CommandBase {
   public:
      // constructor 
...
#endif // __COMMAND_IMAGE_INSERT_TEXT_H__
