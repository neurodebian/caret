...
#ifndef __COMMAND_VERIFY_H__
#define __COMMAND_VERIFY_H__
...
/// class for verifying all commands
class CommandVerify : public CommandBase {
   public:
      // constructor 
      CommandVerify();
