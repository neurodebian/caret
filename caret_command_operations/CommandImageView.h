...
#ifndef __COMMAND_IMAGE_VIEW_H__
#define __COMMAND_IMAGE_VIEW_H__
...
/// class for viewing an image file
class CommandImageView : public CommandBase {
   public:
      // constructor 
      CommandImageView();
...
#endif // __COMMAND_IMAGE_VIEW_H__
