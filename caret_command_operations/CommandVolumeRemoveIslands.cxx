 ...
 * constructor.
 */
CommandVolumeRemoveIslands::CommandVolumeRemoveIslands()
   : CommandBase("-volume-remove-islands",
 ...
 */
void 
CommandVolumeRemoveIslands::getScriptBuilderParameters(ScriptBuilderParameters& paramsOut) const
{
   paramsOut.clear();
 ...
 */
QString 
CommandVolumeRemoveIslands::getHelpInformation() const
{
   QString helpInfo =
 ...
 */
void 
CommandVolumeRemoveIslands::executeCommand() throw (BrainModelAlgorithmException,
                                     CommandException,
                                     FileException,
