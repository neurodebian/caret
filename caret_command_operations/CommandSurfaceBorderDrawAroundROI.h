...
#ifndef __COMMAND_SURFACE_DRAW_BORDER_AROUND_ROI_H__
...
/// class for drawing a border around an ROI
class CommandSurfaceBorderDrawAroundROI : public CommandBase {
   public:
      // constructor 
...
#endif // __COMMAND_SURFACE_DRAW_BORDER_AROUND_ROI_H__
