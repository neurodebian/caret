...
#ifndef __COMMAND_METRIC_ROI_GRADIENT_H__
#define __COMMAND_METRIC_ROI_GRADIENT_H__
...
/// class for
class CommandMetricROIGradient : public CommandBase {
   public:
      // constructor 
...
#endif // __COMMAND_METRIC_ROI_GRADIENT_H__
