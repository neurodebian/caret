...
#ifndef __COMMAND_SURFACE_CURVATURE_H__
#define __COMMAND_SURFACE_CURVATURE_H__
...
/// class for surface curvature
class CommandSurfaceCurvature : public CommandBase {
   public:
      // constructor 
...
#endif // __COMMAND_SURFACE_CURVATURE_H__
