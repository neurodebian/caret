...
#ifndef __COMMAND_SURFACE_BORDER_DRAW_GEODESIC_H__
...
/// class for
class CommandSurfaceBorderDrawGeodesic : public CommandBase {
   public:
      // constructor 
      CommandSurfaceBorderDrawGeodesic();
...
#endif // __COMMAND_SURFACE_BORDER_DRAW_GEODESIC_H__
