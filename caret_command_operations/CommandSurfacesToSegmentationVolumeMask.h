...
#ifndef __COMMAND_SURFACES_TO_SEGMENTATION_VOLUME_MASK_H__
...
/// class for
class CommandSurfacesToSegmentationVolumeMask : public CommandBase {
   public:
      // constructor 
...
#endif // __COMMAND_SURFACES_TO_SEGMENTATION_VOLUME_MASK_H__
