 ...
 * constructor.
 */
CommandVolumeInformationNifti::CommandVolumeInformationNifti()
   : CommandBase("-volume-information-nifti",
                 "VOLUME INFORMATION NIFTI")
{
}
 ...
 */
void 
CommandVolumeInformationNifti::getScriptBuilderParameters(ScriptBuilderParameters& paramsOut) const
{
   paramsOut.clear();
 ...
 */
QString 
CommandVolumeInformationNifti::getHelpInformation() const
{
   QString helpInfo =
 ...
 */
void 
CommandVolumeInformationNifti::executeCommand() throw (BrainModelAlgorithmException,
                                     CommandException,
                                     FileException,
                                     ...
                                     StatisticException)
{
   ...
   NiftiFileHeader niftiHeader;
   niftiHeader.setReadExtensionFlag(true);
   niftiHeader.readHeader(inputVolumeFileName);

   std::cout << niftiHeader.getDescriptionOfHeader().toAscii().constData() << std::endl;
/*
 * VolumeFile volume;
