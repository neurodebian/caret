...
#ifndef __COMMAND_SURFACE_NORMALS_H__
#define __COMMAND_SURFACE_NORMALS_H__
...
/// class for surface normals
class CommandSurfaceNormals : public CommandBase {
   public:
      // constructor
...
#endif // __COMMAND_SURFACE_NORMALS_H__
