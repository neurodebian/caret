...
#ifndef __COMMAND_SYSTEM_FILE_COPY_H__
#define __COMMAND_SYSTEM_FILE_COPY_H__
...
/// class for copying a file
class CommandSystemFileCopy : public CommandBase {
   public:
      // constructor 
...
#endif // __COMMAND_SYSTEM_FILE_COPY_H__
