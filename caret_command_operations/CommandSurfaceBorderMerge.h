...
#ifndef __COMMAND_SURFACE_BORDER_MERGE_H__
#define __COMMAND_SURFACE_BORDER_MERGE_H__
...
/// class for merging borders
class CommandSurfaceBorderMerge : public CommandBase {
   public:
      // constructor 
   ...
   protected:
      ...
      const BorderProjection* getBorderProjectionWithUniqueName(const BorderProjectionFile& bpf,
                                                                const QString& name) const
                                                       throw (CommandException);
};

#endif // __COMMAND_SURFACE_BORDER_MERGE_H__
