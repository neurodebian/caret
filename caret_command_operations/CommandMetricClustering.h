...
#ifndef __COMMAND_METRIC_CLUSTERING_H__
#define __COMMAND_METRIC_CLUSTERING_H__
...
/// class for
class CommandMetricClustering : public CommandBase {
   public:
      // constructor 
...
#endif // __COMMAND_METRIC_CLUSTERING_H__
