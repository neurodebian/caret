...
#ifndef __COMMAND_SURFACE_GENERATE_INFLATED_H__
#define __COMMAND_SURFACE_GENERATE_INFLATED_H__
...
/// class for generating inflated, ellipsoid, and spherical surfaces
class CommandSurfaceGenerateInflated : public CommandBase {
   public:
      // constructor 
   ...
   protected:
      ...
      void writeCoordUpdateSpec(BrainModelSurface* surface,
                                const QString& filename,
                                const QString& specFileName,
                                const QString& specFileTag) throw (FileException);
};

#endif // __COMMAND_SURFACE_GENERATE_INFLATED_H__
