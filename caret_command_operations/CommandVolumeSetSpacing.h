...
#ifndef __COMMAND_VOLUME_SET_SPACING_H__
...
/// class for setting a volumes spacing
class CommandVolumeSetSpacing : public CommandBase {
   public:
      // constructor 
...
#endif // __COMMAND_VOLUME_SET_SPACING_H__
