 ...
 * constructor.
 */
CommandConvertDataFileToCaret7::CommandConvertDataFileToCaret7()
   : CommandBase("-data-file",
 ...
 */
void
CommandConvertDataFileToCaret7::getScriptBuilderParameters(ScriptBuilderParameters& paramsOut) const
{
   paramsOut.clear();
}
 ...
 */
QString
CommandConvertDataFileToCaret7::getHelpInformation() const
{
   QString helpInfo =
      (indent3 + getShortDescription() + "\n"
       ...
       + indent9 + "\n"
       + indent9 + "Since Workbench expects colors to be within the border,\n"
       + indent9 + "foci, label, and label volume files, the appropriate color\n"
       ...
       + indent9 + "as many Workbench data files are structure dependent.\n"
       ...
       + indent9 + "and its data file to Workbench format using \n"
       + indent9 + "   \"wb_import -spec-file\" as it\n"
       + indent9 + "    will convert coordinate and topology files into \n"
       + indent9 + "   surface files and create a spec file that is Workbench \n"
       + indent9 + "   compatible.\n"
       + indent9 + "\n");
 ...
 */
void
CommandConvertDataFileToCaret7::executeCommand() throw (BrainModelAlgorithmException,
                                     CommandException,
                                     FileException,
                                     ...
                                     StatisticException)
{
   ...
   while (parameters->getParametersAvailable()) {
      const QString paramName =
        parameters->getNextParameterAsString("Convert to Caret7 Parameter");
 ...
 */
QString
CommandConvertDataFileToCaret7::convertFile(const QString& inputFileName,
