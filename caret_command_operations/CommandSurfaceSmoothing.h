...
#ifndef __COMMAND_SURFACE_SMOOTHING_H__
#define __COMMAND_SURFACE_SMOOTHING_H__
...
/// class for surface smoothing
class CommandSurfaceSmoothing : public CommandBase {
   public:
      // constructor 
...
#endif // __COMMAND_SURFACE_SMOOTHING_H__
