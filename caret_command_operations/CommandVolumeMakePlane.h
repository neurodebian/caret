...
#ifndef __COMMAND_VOLUME_MAKE_PLANE_H__
#define __COMMAND_VOLUME_MAKE_PLANE_H__
...
/// class for
class CommandVolumeMakePlane : public CommandBase {
   public:
      // constructor 
...
#endif // __COMMAND_VOLUME_MAKE_PLANE_H__
