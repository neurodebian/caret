...
#ifndef __COMMAND_PAINT_ASSIGN_NODES_H__
...
/// class for assigning paint values for nodes
class CommandPaintAssignNodes : public CommandBase {
   public:
      // constructor 
      CommandPaintAssignNodes();
...
#endif // __COMMAND_PAINT_ASSIGN_NODES_H__
