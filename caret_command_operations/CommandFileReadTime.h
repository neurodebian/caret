...
#ifndef __COMMAND_FILE_READ_TIME_H__
#define __COMMAND_FILE_READ_TIME_H__
...
/// class for
class CommandFileReadTime : public CommandBase {
   public:
      // constructor 
      CommandFileReadTime();
   ...
   protected:
      ...
      void readFileForTiming(AbstractFile* dataFile,
                             const QString& fileName,
                             float& timeToReadOut,
                             float& fileSizeInMBOut);
                              
      /// iterations of file reading
      int iterations;
...
#endif // __COMMAND_FILE_READ_TIME_H__
