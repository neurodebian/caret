...
#ifndef __COMMAND_SPEC_FILE_DIRECTORY_CLEAN_H__
...
/// class for
class CommandSpecFileDirectoryClean : public CommandBase {
   public:
      // constructor 
   ...
   protected:
      ...
      bool seeIfFileIsInSpecFile(const std::set<QString>& dataFilesInSpecFile,
                        const QString& name) const;

};

#endif // __COMMAND_SPEC_FILE_DIRECTORY_CLEAN_H__
