...
#ifndef __COMMAND_GIFTI_INFO_H__
#define __COMMAND_GIFTI_INFO_H__
...
/// class for
class CommandGiftiInfo : public CommandBase {
   public:
      // constructor 
      CommandGiftiInfo();
   ...
   protected:
      ...
      // print the metadata
      void printMetaData(std::ostream& outStream,
                         const QString& indent,
                         const GiftiMetaData* md);
};

#endif // __COMMAND_GIFTI_INFO_H__
