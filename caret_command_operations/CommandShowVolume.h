...
#ifndef __COMMAND_SHOW_VOLUME_H__
#define __COMMAND_SHOW_VOLUME_H__
...
/// class for showing a volume
class CommandShowVolume : public CommandBase {
   public:
      // constructor 
      CommandShowVolume();
...
#endif // __COMMAND_SHOW_VOLUME_H__
