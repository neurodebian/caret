...
#ifndef __COMMAND_PREFERENCES_FILE_SETTINGS_H__
...
/// class for setting items in the preferences file
class CommandPreferencesFileSettings : public CommandBase {
   public:
      // constructor 
...
#endif // __COMMAND_PREFERENCES_FILE_SETTINGS_H__
