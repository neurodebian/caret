...
#ifndef __COMMAND_VOLUME_FIND_LIMITS_H__
#define __COMMAND_VOLUME_FIND_LIMITS_H__
...
/// class for
class CommandVolumeFindLimits : public CommandBase {
   public:
      // constructor 
...
#endif // __COMMAND_VOLUME_FIND_LIMITS_H__
