...
#ifndef __COMMAND_VOLUME_TOPOLOGY_CORRECTOR_H__
...
/// class for
class CommandVolumeTopologyCorrector : public CommandBase {
   public:
      // constructor 
      CommandVolumeTopologyCorrector();
...
#endif // __COMMAND_VOLUME_TOPOLOGY_CORRECTOR_H__
